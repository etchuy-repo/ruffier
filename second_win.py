...
class TestWin(QWidget):
    ...
    def next_click(self):
        '''Envía los resultados a la ventana final'''
    ...
    def timer_test(self):
        '''Temporizador de la primera prueba'''
    ...
    def timer_sits(self):
        '''Temporizador de la segunda prueba'''
    ...
    def timer_final(self):
        '''Temporizador de la tercera prueba'''
    ...
    def timer2Event(self):
        ...
        self.text_timer.setText(
            self.time.toString("hh:mm:ss")[6:8]
        )
