...
txt_test1 = (
    'Acuéstese y tome su pulso durante 15 segundos. Haga clic en el botón '
    '"Iniciar primera prueba" para iniciar el temporizador.\n'
    'Escriba el resultado en el campo adecuado.'
)

txt_test2 = (
    'Realice 30 sentadillas durante 45 segundos. Para hacer esto, haga clic '
    'en el botón "Empezar a hacer sentadillas"\n'
    'para iniciar el contador de sentadillas.'
)

txt_test3 = (
    'Acuéstese y tome su pulso los primeros 15 segundos del minuto, luego '
    'durante los últimos 15 segundos del minuto.\n'
    'Presione el botón "Iniciar prueba final" para iniciar el temporizador.\n'
    'Los segundos que deberían medirse se indican en verde y los segundos '
    'que no deben medirse se indican en negro. Escriba los resultados en '
